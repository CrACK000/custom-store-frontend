...
const AnalyticsSubscribersCountriesCard = () => {
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Top countries subscribing to the channel.</CardDescription>
      </CardHeader>
      <CardContent>
...
export default AnalyticsSubscribersCountriesCard